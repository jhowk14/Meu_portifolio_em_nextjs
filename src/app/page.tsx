...
export default function Home() {
  return (
    <>
      <div className="py-16 px-8 text-center bg-gray-900 bg-opacity-60 lg:flex lg:justify-between lg:items-center md:rounded-2xl md:m-5">
      ...
      <section className="py-16 px-8 text-gray-900">
        ...
        <div className='py-16 px-8 text-center bg-green-700 bg-opacity-60 lg:flex lg:justify-between lg:items-center rounded-2xl md:m-5'>
